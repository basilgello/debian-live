...
apt-get install -y bash-completion cifs-utils curl dbus dosfstools firmware-linux-free gddrescue gdisk iputils-ping isc-dhcp-client iw iwd less nfs-common ntfs-3g openssh-client open-vm-tools procps vim wimtools wget
